...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            window.open("${contextPath}/workbench/main/index","workareaFrame");
        });
    </script>
</head>
<body>
        ...
        <ul>
            <li class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="${contextPath}/settings/index"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0; right: 0;">
    ...
    <div id="navigation" style="left: 0; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="${contextPath}/workbench/main/index" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
            ...
            <li class="liClass"><a href="${contextPath}/workbench/activity/index" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
            <li class="liClass"><a href="${contextPath}/workbench/clue/index" target="workareaFrame"><span class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
            <li class="liClass"><a href="${contextPath}/workbench/customer/index" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 客户</a></li>
            <li class="liClass"><a href="${contextPath}/workbench/contacts/index" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
            <li class="liClass"><a href="${contextPath}/workbench/transaction/index" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
            <li class="liClass"><a href="${contextPath}/workbench/visit/index" target="workareaFrame"><span class="glyphicon glyphicon-phone-alt"></span> 售后回访</a></li>
            <li class="liClass">
                <a href="#no2" class="collapsed" data-toggle="collapse"><span class="glyphicon glyphicon-stats"></span> 统计图表</a>
                <ul id="no2" class="nav nav-pills nav-stacked collapse">
                    <li class="liClass"><a href="${contextPath}/workbench/chart/activity/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
                    <li class="liClass"><a href="${contextPath}/workbench/chart/clue/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 线索统计图表</a></li>
                    <li class="liClass"><a href="${contextPath}/workbench/chart/customerAndContacts/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 客户和联系人统计图表</a></li>
                    <li class="liClass"><a href="${contextPath}/workbench/chart/transaction/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易统计图表</a></li>
                </ul>
            </li>
